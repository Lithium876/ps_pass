...
$Module = New-InMemoryModule -ModuleName PwrUPPModule
...
$ServiceAccessRights = psenum $Module PwrUPP.ServiceAccessRights UInt32 @{
...
$SidAttributes = psenum $Module PwrUPP.SidAttributes UInt32 @{
...
$LuidAttributes = psenum $Module PwrUPP.LuidAttributes UInt32 @{
    DISABLED                            =   '0x00000000'
...
$SecurityEntity = psenum $Module PwrUPP.SecurityEntity UInt32 @{
...
$SID_AND_ATTRIBUTES = struct $Module PwrUPP.SidAndAttributes @{
    Sid         =   field 0 IntPtr
    Attributes  =   field 1 UInt32
}

$TOKEN_TYPE_ENUM = psenum $Module PwrUPP.TokenTypeEnum UInt32 @{
    Primary         = 1
    Impersonation   = 2
}

$TOKEN_TYPE = struct $Module PwrUPP.TokenType @{
    Type  = field 0 $TOKEN_TYPE_ENUM
}

$SECURITY_IMPERSONATION_LEVEL_ENUM = psenum $Module PwrUPP.ImpersonationLevelEnum UInt32 @{
    Anonymous         =   0
    Identification    =   1
    Impersonation     =   2
    Delegation        =   3
...
$IMPERSONATION_LEVEL = struct $Module PwrUPP.ImpersonationLevel @{
    ImpersonationLevel  = field 0 $SECURITY_IMPERSONATION_LEVEL_ENUM
}

$TOKEN_GROUPS = struct $Module PwrUPP.TokenGroups @{
    GroupCount  = field 0 UInt32
    Groups      = field 1 $SID_AND_ATTRIBUTES.MakeArrayType() -MarshalAs @('ByValArray', 32)
}

$LUID = struct $Module PwrUPP.Luid @{
    LowPart         =   field 0 $SecurityEntity
    HighPart        =   field 1 Int32
}

$LUID_AND_ATTRIBUTES = struct $Module PwrUPP.LuidAndAttributes @{
    Luid         =   field 0 $LUID
    Attributes   =   field 1 UInt32
}

$TOKEN_PRIVILEGES = struct $Module PwrUPP.TokenPrivileges @{
    PrivilegeCount  = field 0 UInt32
    Privileges      = field 1 $LUID_AND_ATTRIBUTES.MakeArrayType() -MarshalAs @('ByValArray', 50)
}

$Types = $FunctionDefinitions | Add-Win32Type -Module $Module -Namespace 'PwrUPP.NativeMethods'
